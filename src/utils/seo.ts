...
export const defaultSEO: SEOConfig = {
  ...
  description: 'Gudang Mokas adalah showroom mobil bekas terpercaya dengan pilihan lengkap berbagai merek. Dapatkan mobil impian Anda dengan harga terbaik, garansi, dan layanan kredit mudah.',
  keywords: [
    'mobil bekas',
    'showroom mobil',
...
export const organizationStructuredData = {
  ...
  '@type': 'AutoDealer',
  name: 'Gudang Mokas',
  description: 'Showroom mobil bekas berkualitas terpercaya dengan pilihan lengkap berbagai merek',
  url: 'https://gudangmokas.com',

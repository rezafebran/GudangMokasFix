    ...
    <div className="max-w-7xl mx-auto relative z-10">
      ...
      >
        <div className="inline-flex items-center gap-2 px-6 py-3 bg-white/5 backdrop-blur-md rounded-full border border-white/10">
          ...
          <a href="https://wa.me/6281234567890" target="_blank" rel="noopener noreferrer" className="text-emerald-500 text-xs font-bold hover:text-emerald-400 transition-colors">
            Chat via WhatsApp
          </a>
        </div>
      </motion.div>
...
export const TradeInSection = () => (
  <section id="trade-in" className="py-32 px-6 bg-gradient-to-b from-black via-white/5 to-black relative overflow-hidden">
    ...
    <div className="max-w-7xl mx-auto relative z-10">
      ...
      >
        <a 
          href="https://wa.me/6281234567890?text=Halo Gudang Mokas, saya tertarik untuk tukar tambah mobil saya. Bisa minta info lebih lanjut?"
          target="_blank"
...
export const TestimonialsSection = ({ testimonials }: { testimonials: Testimonial[] }) => {
  ...
  return (
    <section id="testimonials" className="py-32 bg-white/5 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <motion.div 
          ...
          className="text-center mb-20 space-y-4"
        >
          <span className="text-white/30 text-xs uppercase tracking-[0.3em]">Happy Stories</span>
          <h2 className="text-5xl font-bold tracking-tighter uppercase">Our Buyers</h2>
        </motion.div>
          ...
          >
            {testimonials.length > 0 ? testimonials.map((t, idx) => (
              <motion.div 
                ...
                viewport={{ once: true }}
                key={t.id} 
                className="relative min-w-[280px] md:min-w-[350px] aspect-[4/5] rounded-3xl overflow-hidden group/item snap-center bg-black/20"
              >
                <div className="absolute inset-0 flex items-center justify-center">
                  <img 
                    src={t.image_url} 
                    alt={t.buyer_name}
                    className="w-full h-full object-cover object-center grayscale group-hover/item:grayscale-0 transition-all duration-700"
                    style={{ objectFit: 'cover' }}
                  />
                </div>
                <div className="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent opacity-60 group-hover/item:opacity-90 transition-opacity duration-500" />
                <div className="absolute inset-0 p-8 flex flex-col justify-end transform translate-y-4 group-hover/item:translate-y-0 transition-transform duration-500">
                  <div className="space-y-3">
                    <p className="text-white font-bold text-2xl tracking-tight leading-none">{t.buyer_name}</p>
                    <div className="flex items-center gap-2">
                      <div className="h-[1px] w-4 bg-white/30" />
                      <p className="text-white/60 text-[10px] uppercase tracking-widest font-medium">{t.car_name}</p>
                    </div>
                    <p className="text-white/80 text-sm italic line-clamp-3 leading-relaxed">"{t.comment}"</p>
                  </div>
                </div>
              </motion.div>
            )) : (
              <div className="w-full text-center py-20 border border-dashed border-white/10 rounded-3xl">
                <p className="text-white/30 text-xs uppercase tracking-widest">No testimonials yet</p>
              </div>
            )}
          </div>
          
          {testimonials.length > 0 && (
            <div className="absolute top-1/2 -translate-y-1/2 left-0 right-0 flex justify-between px-4 pointer-events-none opacity-0 group-hover:opacity-100 transition-opacity">
              <button 
                onClick={() => scroll('left')}
                className="p-4 bg-white/10 backdrop-blur-md rounded-full text-white pointer-events-auto hover:bg-white/20 transition-all"
              >
                <ChevronLeft size={24} />
              </button>
              <button 
      ...
      <div className="col-span-1 md:col-span-2 space-y-8">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-white/40 text-[10px] uppercase tracking-[0.3em]">Traders Used Car</span>
          </div>
        </div>
      ...
      <div className="space-y-12 max-w-5xl mx-auto">
        <div className="space-y-6">
          <div 
            ...
            className="relative aspect-[21/9] rounded-3xl overflow-hidden border border-white/10 group/slider cursor-zoom-in"
          >
            <motion.img 
            ...
            {car.images.length > 1 && (
              <>
                <button 
                  ...
                  className="absolute left-4 top-1/2 -translate-y-1/2 p-3 bg-black/50 backdrop-blur-md rounded-full text-white opacity-0 group-hover/slider:opacity-100 transition-opacity hover:bg-white hover:text-black"
                >
                  <ChevronLeft size={20} />
                </button>
                <button 
                  ...
                  className="absolute right-4 top-1/2 -translate-y-1/2 p-3 bg-black/50 backdrop-blur-md rounded-full text-white opacity-0 group-hover/slider:opacity-100 transition-opacity hover:bg-white hover:text-black"
                >
        ...
        <div className="space-y-10">
          ...
          <div className="pt-8">
            <a 
              href={`https://wa.me/6281234567890?text=Halo Gudang Mokas, saya tertarik dengan unit ${car.brand} ${car.name} ${car.year}. Bisa minta info lebih lanjut?`}
              target="_blank"
              rel="noopener noreferrer"
